    ...
    >
      ...
      {form.attributes.length > 0 ? (
        <form className="space-y-3.5" action={formAction}>
          ...
          {form.attributes.map((attr: any) => (
            <Card key={attr.marker}>
              <CardContent className="grid w-full max-2-xl pt-6 items-center gap-1.5">
                ...
                {attr.listTitles.length > 0 ? (
                  <RadioGroup
                    ...
                    name={attr.marker}
                  >
                    {attr.listTitles.map((listTitle: any) => (
                      <div
                        key={listTitle.value}
          ...
          {publicForm ? (
            ...
            <div className="mt-6">
              <Link
                ...
                href={"https://aadizee-google-forms.oneentry.cloud/"}
              >
                To make any edits to this form, please visit oneentry cms.
              </Link>
            </div>
          )}
        </form>
